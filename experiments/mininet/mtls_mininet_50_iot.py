#!/usr/bin/env python3
"""
Run the mTLS authentication baseline inside a Mininet IoT simulation.
...
What this script does:
  1. Builds the required Rust binary for mTLS.
  ...
  5. Runs one mTLS authentication attempt per simulated IoT device.
  6. Saves a CSV including client_type for every run.

Example:
  sudo python3 mtls_mininet_50_iot.py --project /mnt/data/zk1/zk-arche-compare-main
"""
...
PROTOCOL_CONFIG = {
    "mtls": {
        ...
        "port": 7443,
        "server_args": "{bind}",
        "client_args": "{server} localhost",
        "default_csv": "mtls_mininet_results.csv",
        "title": "mTLS",
        "needs_certs": True,
    },
}
